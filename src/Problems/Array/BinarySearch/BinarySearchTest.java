...
public class BinarySearchTest {
    ...
    public static void main(String[] args) {
        ...
        runTest(solution, inputs);
    }

    private static void runTest(BinarySearchSolution solution, int[][][] inputs) {
        ...
        for (int i = 0; i < inputs.length; i++) {
            ...
            int expected = inputs[i][2][0];

            long startTime = System.nanoTime();
            int actual = solution.search(arr, target);
